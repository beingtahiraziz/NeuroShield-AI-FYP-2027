...
// a reverse proxy. Read at runtime from a <meta name="neuroshield-base-path"> tag that
// the backend injects into index.html (and the vite dev server injects in dev,
// from NEUROSHIELD_CONTEXT_PATH). A <meta> tag is used rather than an inline <script>
...
const _meta =
  (typeof document !== 'undefined' &&
    document
      .querySelector('meta[name="neuroshield-base-path"]')
