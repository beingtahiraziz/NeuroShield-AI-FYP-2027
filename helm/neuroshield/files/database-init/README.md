...
1. Copy it here: `cp database/init/NEWFILE.sql helm/neuroshield/files/database-init/`
...
`diff -r database/init helm/neuroshield/files/database-init` and fails on
