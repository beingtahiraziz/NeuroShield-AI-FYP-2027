...
-- Grant Permissions
-- ============================================================================
GRANT SELECT, INSERT, UPDATE, DELETE ON system_config TO neuroshield;
GRANT SELECT, INSERT, UPDATE, DELETE ON user_preferences TO neuroshield;
GRANT SELECT, INSERT, UPDATE, DELETE ON integration_configs TO neuroshield;
GRANT SELECT, INSERT ON config_audit_log TO neuroshield;
GRANT USAGE, SELECT ON SEQUENCE config_audit_log_id_seq TO neuroshield;
GRANT SELECT ON enabled_integrations TO neuroshield;
GRANT SELECT ON recent_config_changes TO neuroshield;
